...
public class BigClassAdapter extends RecyclerView.Adapter<BigClassAdapter.ItemViewHolder> {
    private List<BigClass> mData;

    private OnItemClickListener mOnItemClickListener;

    public BigClassAdapter(List<BigClass> data) {
        this.mData = data;
    }
